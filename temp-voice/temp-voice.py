...
class TempVoice(commands.Cog): # create a class for our cog that inherits from commands.Cog
    ...
    async def on_voice_state_update(self, member, before, after):
        joinToCreateVoice = 1034525369648287904 # the voice channel id that will be used to create the channel - Tri Server
        joinToCreateParent = 1034525261963739146 # the category id where the channel will be created - Tri Server
